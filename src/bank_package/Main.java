 ...
 * information like BankApplicationPackage.ChexSystems report (the banking equivalent of a credit check), available balance
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CheckingAccountApplication test = new CheckingAccountApplication();

        test.PrintScreenResult();
