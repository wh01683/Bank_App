...
class MoneyMarketAccount implements Account, Serializable {
    ...
    public MoneyMarketAccount(Customer customer, double openingBalance, Integer accountNumber) {
...
// --Commented out by Inspection STOP (3/27/15 8:02 PM)
    ...
    public Account applyForNewAccount(Customer customer, double openingBalance, Integer accountNumber) {
        ...
        if(decideApproved(customer, openingBalance)){
            return new MoneyMarketAccount(customer, openingBalance, accountNumber);
        }
        else{
